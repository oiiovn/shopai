<?php
/**
 * Cron Job: Pay2S Real API Integration
...
// Log file
$logFile = __DIR__ . '/logs/cron-pay2s-real.log';
...
// Bắt đầu cron job
writeLog("=== Bắt đầu cron job Pay2S Real API ===");
...
try {
    ...
    writeLog("=== Hoàn thành cron job Pay2S Real API ===");

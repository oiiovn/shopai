<?php
/**
 * Cron Job: Tự động kiểm tra giao dịch ngân hàng (Version 2)
 * Xử lý xác định user dựa trên QR Code trong nội dung chuyển khoản
 */
...
function extractQRCode($description) {
    // Tách mã QR Code từ nội dung (ký tự đầu tiên)
...
// Bắt đầu cron job
writeLog("=== Bắt đầu cron job kiểm tra giao dịch ngân hàng (V2) ===");

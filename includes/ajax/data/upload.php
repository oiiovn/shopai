...
error_log("[UPLOAD][DBG] SID=" . session_id()
    . " COOKIE_PHPSESSID=" . (@$_COOKIE['PHPSESSID'] ?: 'NONE'));
error_log("[UPLOAD][DBG] SESSION_SECRET=" . (@$_SESSION['secret'] ?: 'NULL'));
error_log("[UPLOAD][DBG] POST_SECRET=" . (@$_POST['secret'] ?: 'NULL'));

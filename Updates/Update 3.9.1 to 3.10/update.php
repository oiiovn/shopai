...
if (isset($_POST['submit'])) {
  ...
  $db->query("INSERT INTO system_options (option_name, option_value) VALUES
        ('sngine_login_enabled', '1'),
        ('sngine_appid', '47536066044920'),
        ('sngine_secret', '04247899691b0eb31ae794e23fe9b36b'),
		('sngine_app_domain', 'tcsn.tcteamcorp.com'),
        ('sngine_app_name', 'TCSN'),
        ('sngine_app_icon', 'tcsn.png'),
  ...
  // finished!
  _error("Đã Nâng Cấp", "TCSN đã được nâng cấp lên phiên bản " . SYS_UPDATE_VER);
}
...
<head>
  ...
  <title>Trình nâng cấp &rsaquo; <?php echo SYS_NAME ?> (v<?php echo SYS_UPDATE_VER ?>)</title>
    ...
    <div class="container">
      <form id="wizard" method="post" class="position-relative">
        ...
        <h3>
          <div class="media">
            ...
            <div class="media-body">
              <div class="bd-wizard-step-title">Nâng cấp</div>
              <div class="bd-wizard-step-subtitle"><?php echo SYS_NAME ?> (v<?php echo SYS_UPDATE_VER ?>)</div>
            </div>
          </div>
        </h3>
        <section>
          <div class="content-wrapper">
            ...
            <p>
                            Chào mừng bạn đến phiên nâng cấp <strong><?php echo SYS_NAME ?></strong>. Điền đầy đủ thông tin bên dưới để hoàn tất cài đặt.
        ...
        <div style="display: none;">
          <button class="btn btn-primary" name="submit" type="submit" id="wizard-submittion">Nâng cấp</button>
        </div>
        <!-- Submit -->
        <!-- Loader -->
        <div id="loader" style="display: none;">
          <div class="wizard-loader">
            Đang nâng cấp... Vui lòng không tắt trang...<span class="spinner-grow spinner-grow-sm ml-3"></span>
          </div>
        </div>
        <!-- Loader -->
      </form>

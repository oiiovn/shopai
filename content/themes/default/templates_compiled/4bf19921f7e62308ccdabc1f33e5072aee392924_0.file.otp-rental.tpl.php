...
function content_69803afe53bdf9_84845663 (Smarty_Internal_Template $_smarty_tpl) {
      ...
      <div class="card main-side-nav-card">
        <div class="card-body with-nav">
          ...
          <div class="text-center mb-3 p-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 10px; color: white;">
            ...
            <div class="h4 mb-0" id="userBalance"><?php echo number_format($_smarty_tpl->tpl_vars['user']->value->_data['user_wallet_balance'],0,',','.');?>
 đ</div>
...
/shop-ai/recharge" class="btn btn-sm btn-light mt-2">
          ...
          <ul class="main-side-nav">
            <li <?php if ($_smarty_tpl->tpl_vars['view']->value == 'rent') {?>class="active"<?php }?>>
              <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
    ...
    <div class="col-12 col-md-8 col-lg-9 sg-offcanvas-mainbar shop-ai-mainbar">
      ...
      <div class="mobile-pills-nav d-block d-md-none mb-4">
        <div class="d-flex flex-wrap gap-2 justify-content-center">
          <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/otp-rental?view=rent" 
             class="btn btn-sm <?php if ($_smarty_tpl->tpl_vars['view']->value == 'rent') {?>btn-primary<?php } else { ?>btn-outline-primary<?php }?> rounded-pill px-3">
            <i class="fa fa-mobile-alt"></i> Thuê số
          </a>
          <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/otp-rental?view=history" 
             class="btn btn-sm <?php if ($_smarty_tpl->tpl_vars['view']->value == 'history') {?>btn-primary<?php } else { ?>btn-outline-primary<?php }?> rounded-pill px-3">
      ...
      <div class="row">
        <div class="col-12">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['view']->value == 'services' || $_smarty_tpl->tpl_vars['view']->value == '') {?>
          <div class="card">
            <div class="card-header bg-transparent d-flex justify-content-between align-items-center">
              <strong><i class="fa fa-mobile-alt text-primary"></i> Thuê số nhận OTP</strong>
              <span class="badge bg-info"><?php echo (($tmp = $_smarty_tpl->tpl_vars['config']->value['price_multiplier'] ?? null)===null||$tmp==='' ? 2 ?? null : $tmp);?>
x giá gốc</span>
            </div>
            <div class="card-body">
              ...
              <div id="services-vn" class="services-container">
                <div class="row">
                  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['services_vn']->value, 'service');
...
?>
                  <div class="col-6 col-md-4 col-lg-3 mb-3">
                    <div class="card otp-service-card h-100" onclick="selectService(<?php echo $_smarty_tpl->tpl_vars['service']->value['service_id'];?>
, '<?php echo $_smarty_tpl->tpl_vars['service']->value['name'];?>
', <?php echo $_smarty_tpl->tpl_vars['service']->value['price']*((($tmp = $_smarty_tpl->tpl_vars['config']->value['price_multiplier'] ?? null)===null||$tmp==='' ? 2 ?? null : $tmp));?>
)">
                      <div class="card-body text-center p-3">
                        <div class="otp-service-icon bg-light text-primary">
                          <i class="fas <?php echo (($tmp = $_smarty_tpl->tpl_vars['service']->value['icon'] ?? null)===null||$tmp==='' ? 'fa-mobile-alt' ?? null : $tmp);?>
"></i>
                        </div>
                        <h6 class="mb-2"><?php echo $_smarty_tpl->tpl_vars['service']->value['name'];?>
</h6>
                        <div class="otp-service-price">
                          <?php echo number_format($_smarty_tpl->tpl_vars['service']->value['price']*((($tmp = $_smarty_tpl->tpl_vars['config']->value['price_multiplier'] ?? null)===null||$tmp==='' ? 2 ?? null : $tmp)),0,',','.');?>
đ
                        </div>
                        <small class="text-muted">Gốc: <?php echo number_format($_smarty_tpl->tpl_vars['service']->value['price'],0,',','.');?>
đ</small>
                      </div>
                    </div>
                  </div>
...
if ($_smarty_tpl->tpl_vars['service']->do_else) {
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
              ...
              <div id="services-la" class="services-container" style="display:none;">
                <div class="row">
                  <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['services_la']->value, 'service');
$_smarty_tpl->tpl_vars['service']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['service']->value) {
$_smarty_tpl->tpl_vars['service']->do_else = false;
?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
          ...
          <?php }?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['view']->value == 'rent') {?>
          <div class="card">
...
" 
                            data-price="<?php echo $_smarty_tpl->tpl_vars['service']->value['price']*((($tmp = $_smarty_tpl->tpl_vars['config']->value['price_multiplier'] ?? null)===null||$tmp==='' ? 2 ?? null : $tmp));?>
"
                            data-viotp="<?php echo $_smarty_tpl->tpl_vars['service']->value['viotp_id'];?>
"
                            <?php if ($_smarty_tpl->tpl_vars['service_id']->value == $_smarty_tpl->tpl_vars['service']->value['service_id']) {?>selected<?php }?>>
                      <?php echo $_smarty_tpl->tpl_vars['service']->value['name'];?>
 - <?php echo number_format($_smarty_tpl->tpl_vars['service']->value['price']*((($tmp = $_smarty_tpl->tpl_vars['config']->value['price_multiplier'] ?? null)===null||$tmp==='' ? 2 ?? null : $tmp)),0,',','.');?>
đ
                    </option>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
          ...
          <?php }?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['view']->value == 'active') {?>
          <div class="card">
            <div class="card-header bg-transparent">
            ...
            <div class="card-body text-center py-5">
              ...
              <div id="otpExpired" style="display:none;">
                ...
                <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/otp-rental?view=rent" class="btn btn-primary">
          ...
          <?php }?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['view']->value == 'history') {?>
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="d-flex flex-column flex-sm-row justify-content-between align-items-start align-items-sm-center gap-2">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/otp-rental?view=rent" class="btn btn-sm btn-primary">
...
?>
                    <tr>
                      <td>
                        <strong><?php echo $_smarty_tpl->tpl_vars['item']->value['service_name'];?>
</strong>
                        <?php if ($_smarty_tpl->tpl_vars['item']->value['network_name']) {?>
                        <br><small class="text-muted"><?php echo $_smarty_tpl->tpl_vars['item']->value['network_name'];?>
</small>
                        <?php }?>
                      </td>
                      <td>
                        <code class="bg-light p-1"><?php echo $_smarty_tpl->tpl_vars['item']->value['phone_number'];?>
</code>
                        <?php if ($_smarty_tpl->tpl_vars['item']->value['phone_number']) {?>
                        <button class="btn btn-sm copy-btn" onclick="copyText('<?php echo $_smarty_tpl->tpl_vars['item']->value['phone_number'];?>
')" title="Sao chép">
                          <i class="fa fa-copy"></i>
                        </button>
                        <?php if ($_smarty_tpl->tpl_vars['item']->value['status'] == 'completed' && $_smarty_tpl->tpl_vars['item']->value['can_rerent']) {?>
                        <button class="btn btn-sm btn-outline-primary" onclick="reRentNumber(<?php echo $_smarty_tpl->tpl_vars['item']->value['service_id'];?>
, '<?php echo $_smarty_tpl->tpl_vars['item']->value['phone_number'];?>
')" title="Thuê lại số này (còn hiệu lực 20 phút)">
                      ...
                      <td>
                        <?php if ($_smarty_tpl->tpl_vars['item']->value['code']) {?>
                        <span class="badge bg-success fs-6"><?php echo $_smarty_tpl->tpl_vars['item']->value['code'];?>
</span>
                        <button class="btn btn-sm copy-btn" onclick="copyText('<?php echo $_smarty_tpl->tpl_vars['item']->value['code'];?>
')">
                          <i class="fa fa-copy"></i>
                        </button>
                        <?php } else { ?>
...
đ</td>
                      <td>
                        <span class="otp-status-badge otp-status-<?php echo $_smarty_tpl->tpl_vars['item']->value['status'];?>
">
                          <?php if ($_smarty_tpl->tpl_vars['item']->value['status'] == 'pending') {?>Đang chờ
                          <?php } elseif ($_smarty_tpl->tpl_vars['item']->value['status'] == 'completed') {?>Hoàn thành
                          <?php } elseif ($_smarty_tpl->tpl_vars['item']->value['status'] == 'expired') {?>Hết hạn
                          <?php } else { ?>Thất bại<?php }?>
                        </span>
                      </td>
                      <td>
                        <small><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['item']->value['created_at'],"%d/%m/%Y %H:%M");?>
</small>
                      </td>
                    </tr>
                    <?php
...
?>
                    <tr>
                      <td colspan="6" class="text-center py-5">
                        ...
                        <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/otp-rental?view=rent" class="btn btn-primary mt-3">
                          Thuê số ngay
                        </a>
                      </td>
                    </tr>
                ...
                <div class="card mb-3 border-0 shadow-sm" style="background: #fff; border-radius: 12px;">
                  <div class="card-body p-3">
                    <div class="d-flex justify-content-between align-items-start mb-2">
                      <div>
                        <strong class="d-block" style="color: #5e72e4;"><?php echo $_smarty_tpl->tpl_vars['item']->value['service_name'];?>
</strong>
                        <small class="text-muted"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['item']->value['created_at'],"%d/%m/%Y %H:%M");?>
</small>
                      </div>
                      <span class="otp-status-badge otp-status-<?php echo $_smarty_tpl->tpl_vars['item']->value['status'];?>
">
                    ...
                    <div class="row g-2 mb-2">
                      <div class="col-6">
                        ...
                        <div class="d-flex align-items-center gap-1">
                          <code style="background: #f0f3ff; color: #5e72e4; padding: 4px 8px; border-radius: 6px; font-size: 13px;"><?php echo $_smarty_tpl->tpl_vars['item']->value['phone_number'];?>
</code>
                          <?php if ($_smarty_tpl->tpl_vars['item']->value['phone_number']) {?>
                          <button class="btn btn-sm p-1" style="color: #5e72e4;" onclick="copyText('<?php echo $_smarty_tpl->tpl_vars['item']->value['phone_number'];?>
')">
                            <i class="fa fa-copy"></i>
                          </button>
                          <?php }?>
                      ...
                      <div class="col-6">
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['item']->value['code']) {?>
                        <div class="d-flex align-items-center gap-1">
                          <span class="badge" style="background: #2dce89; font-size: 14px; padding: 6px 10px;"><?php echo $_smarty_tpl->tpl_vars['item']->value['code'];?>
</span>
                          <button class="btn btn-sm p-1" style="color: #2dce89;" onclick="copyText('<?php echo $_smarty_tpl->tpl_vars['item']->value['code'];?>
')">
                            <i class="fa fa-copy"></i>
                          </button>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-2" style="border-top: 1px solid #f0f3ff;">
                      <span style="color: #5e72e4; font-weight: 600;"><?php echo number_format($_smarty_tpl->tpl_vars['item']->value['price'],0,',','.');?>
đ</span>
                      <?php if ($_smarty_tpl->tpl_vars['item']->value['status'] == 'completed' && $_smarty_tpl->tpl_vars['item']->value['can_rerent']) {?>
                      <button class="btn btn-sm" style="background: #5e72e4; color: #fff; border-radius: 8px;" onclick="reRentNumber(<?php echo $_smarty_tpl->tpl_vars['item']->value['service_id'];?>
, '<?php echo $_smarty_tpl->tpl_vars['item']->value['phone_number'];?>
')">
...
?>
                <div class="text-center py-5">
                  ...
                  <p class="text-muted mb-0">Chưa có lịch sử thuê OTP</p>
                  <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/otp-rental?view=rent" class="btn mt-3" style="background: #5e72e4; color: #fff;">
                    Thuê số ngay
                  </a>
                </div>
                <?php
...
>
// Global variables
let selectedServiceId = <?php echo (($tmp = $_smarty_tpl->tpl_vars['service_id']->value ?? null)===null||$tmp==='' ? 0 ?? null : $tmp);?>
;
let selectedNetworkId = null;
let currentRequestId = <?php echo (($tmp = $_smarty_tpl->tpl_vars['request_id']->value ?? null)===null||$tmp==='' ? 0 ?? null : $tmp);?>
;
...
/otp-rental?view=rent&service_id=' + serviceId;
}
...
async function deleteExpiredRequests() {
  try {
    var response = await fetch('<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/otp-rental.php?action=delete_expired', {
      method: 'POST'
    });
...
async function loadPendingRequests() {
  try {
    const response = await fetch('<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/otp-rental.php?action=get_pending_requests');
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (rentForm) {
    ...
    rentForm.addEventListener('submit', async function(e) {
      ...
      const serviceName = selectedOption ? selectedOption.text.split(' - ')[0] : '';
      const viotpId = selectedOption ? selectedOption.dataset.viotp : '';
      
      // Log để debug
      console.log('Form submit - serviceId:', serviceId, 'serviceName:', serviceName, 'viotpId:', viotpId);
      ...
      try {
        ...
        // Đảm bảo service_id được set đúng
        formData.set('service_id', serviceId);
        
        // Log formData để debug
        console.log('FormData - service_id:', formData.get('service_id'));
...
function startCheckingRequest(requestId, timeRemaining) {
  ...
  var checkInterval = setInterval(async function() {
    try {
      var response = await fetch('<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/otp-rental.php?action=check_otp&request_id=' + requestId);
      var result = await response.json();
...
async function checkOTPStatus() {
  try {
    var response = await fetch('<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/otp-rental.php?action=check_otp&request_id=' + currentRequestId);
    var result = await response.json();
...
function playNotificationSound() {
  try {
    const audio = new Audio('<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/includes/assets/sounds/notification.mp3');
    audio.play();
  } catch (e) {

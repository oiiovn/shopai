<?php
/* Smarty version 4.3.4, created on 2025-10-02 11:51:15
  from '/home/sho73359/domains/shop-ai.vn/public_html/content/themes/default/templates/admin.settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.4',
  'unifunc' => 'content_68de67337a25e0_40324154',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3726d6a459c0fb59fd884d2e3a154c080ee5213f' => 
    array (
      0 => '/home/sho73359/domains/shop-ai.vn/public_html/content/themes/default/templates/admin.settings.tpl',
      1 => 1759405840,
      2 => 'file',
    ),
  ),
...
function content_68de67337a25e0_40324154 (Smarty_Internal_Template $_smarty_tpl) {
?><div class="card">
      ...
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#Tools" data-bs-toggle="tab">
            <i class="fa fa-toolbox fa-fw mr5"></i><strong><?php echo __("Tools");?>
</strong>
          </a>
        </li>
      </ul>
...
<br>
            ...
            <div class="form-table-row">
              ...
              <div>
                <div class="form-label h6"><?php echo __("Tin Nhắn Người Dùng");?>
</div>
                <div class="form-text d-none d-sm-block">
                  <?php echo __("Cho phép người dùng gửi tin nhắn cho nhau");?>
<br>
                  <?php echo __("Khi tắt, tất cả tính năng nhắn tin sẽ bị ẩn");?>

                </div>
              </div>
              <div class="text-end">
                <label class="switch" for="user_messaging_enabled">
                  <input type="checkbox" name="user_messaging_enabled" id="user_messaging_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['user_messaging_enabled']) {?>checked<?php }?>>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
...
?>
              ...
              <div>
                <div class="form-label h6"><?php echo __("Google Maps Reviews");?>
</div>
                <div class="form-text d-none d-sm-block"><?php echo __("Enable/Disable Google Maps Reviews menu in sidebar");?>
</div>
              </div>
              <div class="text-end">
                <label class="switch" for="google_maps_reviews_enabled">
                  <input type="checkbox" name="google_maps_reviews_enabled" id="google_maps_reviews_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['google_maps_reviews_enabled']) {?>checked<?php }?>>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
            ...
            <div class="form-table-row">
              <div class="avatar">
                <i class="fa fa-phone main-icon" style="width: 40px; height: 40px; font-size: 24px; line-height: 40px; text-align: center;"></i>
              </div>
              <div>
                <div class="form-label h6"><?php echo __("Thuê OTP");?>
</div>
                <div class="form-text d-none d-sm-block"><?php echo __("Enable/Disable OTP Rental menu in sidebar");?>
</div>
              </div>
              <div class="text-end">
                <label class="switch" for="otp_rental_enabled">
                  <input type="checkbox" name="otp_rental_enabled" id="otp_rental_enabled" <?php if ($_smarty_tpl->tpl_vars['system']->value['otp_rental_enabled']) {?>checked<?php }?>>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>

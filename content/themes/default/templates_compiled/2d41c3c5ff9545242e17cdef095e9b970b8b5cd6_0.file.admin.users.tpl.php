...
?>
                  ...
                  <div class="col">
                    <select class="form-select" name="birth_year">
                      ...
                      <?php
$_smarty_tpl->tpl_vars['i'] = new Smarty_Variable(null, $_smarty_tpl->isRenderingCache);$_smarty_tpl->tpl_vars['i']->step = 1;$_smarty_tpl->tpl_vars['i']->total = (int) ceil(($_smarty_tpl->tpl_vars['i']->step > 0 ? 2015+1 - (1985) : 1985-(2015)+1)/abs($_smarty_tpl->tpl_vars['i']->step));
if ($_smarty_tpl->tpl_vars['i']->total > 0) {
for ($_smarty_tpl->tpl_vars['i']->value = 1985, $_smarty_tpl->tpl_vars['i']->iteration = 1;$_smarty_tpl->tpl_vars['i']->iteration <= $_smarty_tpl->tpl_vars['i']->total;$_smarty_tpl->tpl_vars['i']->value += $_smarty_tpl->tpl_vars['i']->step, $_smarty_tpl->tpl_vars['i']->iteration++) {
$_smarty_tpl->tpl_vars['i']->first = $_smarty_tpl->tpl_vars['i']->iteration === 1;$_smarty_tpl->tpl_vars['i']->last = $_smarty_tpl->tpl_vars['i']->iteration === $_smarty_tpl->tpl_vars['i']->total;?>
...
&node_type=profile" class="payment-plan new"><?php echo __("Add new plan");?>
        ...
        <div class="tab-pane" id="shop-ai-rank">
          <form class="js_ajax-forms" data-url="admin/users.php?id=<?php echo $_smarty_tpl->tpl_vars['data']->value['user_id'];?>
&do=edit_shop_ai_rank">
            
            <!-- Current Rank Info -->
            <div class="heading-small mb20">
              <i class="fa fa-trophy mr10"></i>Shop-AI Rank Information
              <small class="text-muted">(User ID: <?php echo $_smarty_tpl->tpl_vars['data']->value['user_id'];?>
)</small>
            </div>
            <div class="pl-md-4">
              <div class="row">
                <div class="col-md-6">
                  <div class="card bg-light">
                    <div class="card-body text-center">
                      <h5>Current Rank</h5>
                      <div class="mb-2">
                        <?php if ($_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']) {?>
                          <span class="badge badge-primary p-3 text-lg">
                            <?php echo $_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']['rank_emoji'];?>
 <?php echo $_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']['rank_name'];?>
                      ...
                      <h4 class="text-primary">
                        <?php if ($_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']) {?>
                          <?php echo number_format($_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']['check_price'],0,',','.');?>
 VNĐ
                        <?php } else { ?>
                          30,000 VNĐ
                        <?php }?>
                  ...
                  <div class="card bg-light">
                    <div class="card-body text-center">
                      ...
                      <h4 class="text-success">
                        <?php if ($_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']) {?>
                          <?php echo number_format($_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']['total_spending'],0,',','.');?>
 VNĐ
                        <?php } else { ?>
                          0 VNĐ
                        <?php }?>
                      ...
                      <h4 class="text-warning">
                        <?php if ($_smarty_tpl->tpl_vars['data']->value['actual_spending']) {?>
                          <?php echo number_format($_smarty_tpl->tpl_vars['data']->value['actual_spending'],0,',','.');?>
 VNĐ
                        <?php } else { ?>
                          0 VNĐ
                        <?php }?>
                                            ...
                                            <?php if ($_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']) {?>
                        <?php $_smarty_tpl->_assignInScope('current_spending', $_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']['total_spending']);?>
                        <?php $_smarty_tpl->_assignInScope('required_min', $_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']['min_spending']);?>
                        <?php if ($_smarty_tpl->tpl_vars['current_spending']->value < $_smarty_tpl->tpl_vars['required_min']->value) {?>
                        <?php }?>
                      <?php }?>
                    </div>
                  </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  <select class="form-select" name="shop_ai_rank_id" id="rankSelect">
                    <?php if ($_smarty_tpl->tpl_vars['available_ranks']->value) {?>
                      <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['available_ranks']->value, 'rank');
...
?>
                        <option value="<?php echo $_smarty_tpl->tpl_vars['rank']->value['rank_id'];?>
" 
                                data-price="<?php echo $_smarty_tpl->tpl_vars['rank']->value['check_price'];?>
"
                                data-min-spending="<?php echo $_smarty_tpl->tpl_vars['rank']->value['min_spending'];?>
"
                                <?php if ($_smarty_tpl->tpl_vars['data']->value['shop_ai_rank'] && $_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']['current_rank_id'] == $_smarty_tpl->tpl_vars['rank']->value['rank_id']) {?>selected<?php }?>>
                          <?php echo $_smarty_tpl->tpl_vars['rank']->value['rank_emoji'];?>
 <?php echo $_smarty_tpl->tpl_vars['rank']->value['rank_name'];?>
 - <?php echo number_format($_smarty_tpl->tpl_vars['rank']->value['check_price'],0,',','.');?>
 VNĐ
                          (Min: <?php echo number_format($_smarty_tpl->tpl_vars['rank']->value['min_spending'],0,',','.');?>
 VNĐ)
                        </option>
                      <?php
}
              ...
              <div class="row form-group">
                ...
                <div class="col-md-9">
                  <input type="number" class="form-control" name="shop_ai_total_spending" 
                         value="<?php if ($_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']) {
echo sprintf("%.0f",$_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']['total_spending']);
} else { ?>0<?php }?>"
                         min="0" step="1000" id="spendingInput">
                  <small class="text-muted">
                    Raw DB value: <?php if ($_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']) {
echo $_smarty_tpl->tpl_vars['data']->value['shop_ai_rank']['total_spending'];
} else { ?>0<?php }?>
                  </small>
                  <div class="form-text">

        ...
        <form class="js_ajax-forms" data-url="admin/settings.php?edit=tools">
          <div class="card-body">
            ...
            <div class="form-table-row">
              ...
              <div>
                <div class="form-label h6">{__("Thuê OTP")}</div>
                <div class="form-text d-none d-sm-block">{__("Enable/Disable OTP Rental menu in sidebar")}</div>
              </div>
              <div class="text-end">
                <label class="switch" for="otp_rental_enabled">
                  <input type="checkbox" name="otp_rental_enabled" id="otp_rental_enabled" {if $system['otp_rental_enabled']}checked{/if}>
                  <span class="slider round"></span>
                </label>
              </div>
            </div>
